...
import { dummyConversations, dummyProjects, dummyVersion } from '../assets/assets.ts';
  ...
  return project ? (
    <div className='flex flex-col h-screen w-full bg-gray-800 text-white'>
      ...
      <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
        ...
        {/* right side */}
        <div className='flex items-center justify-end gap-4 flex-1 text-xs sm:text-sm'>

          <button onClick={saveProject} disabled={isSaving} className='max-sm bg-gray-800 hover:bg-gray-700 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors border border-gray-700'>
          ...
          <button onClick={downloadCode} className='bg-linear-to-br from-blue-700 to-blue-500 hover:from-blue-500  hover:to-blue-500 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors'>
            <ArrowBigDownDash size={16}/> Download
          </button>

          <button onClick={togglePublish} className='bg-linear-to-br from-indigo-700 to-indigo-500 hover:from-indigo-500  hover:to-indigo-500 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors'>
            {project.isPublished ? 
