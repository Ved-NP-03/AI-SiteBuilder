...
const Pricing = () => {
  ...
  return (
    <>
      <div className='w-full max-w-5xl mx-auto z-20 mx-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          <h2 className='text-3xl font-medium text-gray-100'>Choose Your Plan</h2>
          <p className='text-gray-400 mt-2 text-sm mx-auto max-w-md'>Select the plan that best fits your needs and start building amazing websites with AI SiteBuilder.</p>
        </div>
        ...
        <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>Project <span className='text-white'>Creation/Revision</span> Consume <span className='text-white'>5 Credits</span>. You can also <span className='text-white'>upgrade</span> your plan at any time.</p>
