...
const ProjectPreview = forwardRef<ProjectPreviewRef,ProjectPreviewProps>(({project,isGenerating,device = 'desktop' , showEditorPanel = true}, ref) => {
  ...
  useImperativeHandle(ref,()=>({
    getCode:()=>{
      ...
      //Remove class like when we do live editing a black box appears which shld be removed while downloading
      ...
      //remove injected style n script
      ...
      //order or in sequence clean HTML code
  ...
  return (
    ...
    <div className='relative h-full bg-gray-900 flex-1 rounded-xl overflow-hidden max-sm:m1-2'>
