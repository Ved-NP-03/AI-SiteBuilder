  ...
  return (
    <div className='absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-fade-in fade-in '>
        ...
        <div className='space-y-4 text-black'>
            ...
            <div>
                <label className='block text-xs font-medium text-gray-400 mb-1'>Class Name</label>
            ...
            <div className='grid grid-cols-2 gap-3'>
                ...
                <div>
                    <label className='block text-xs font-medium text-gray-400 mb-1'>Margin</label>
                    <input type='text' 
            ...
            <div className='grid grid-cols-2 gap-3'>
                ...
                <div>
                    <label className='block text-xs font-medium text-gray-400 mb-1'>TextColor</label>
                    <div className='flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                        <input type='color' 
